...
__fcstdFile__ = "diodeThmDO_V.FCStd"
__desc__ = "DO-x Vertical"


class modelPreview(modelPreviewMain):
     def __init__(self, parent=None):
        modelPreviewMain.__init__(self, "diodeThmDO_V.png", __desc__, parent)
...
class modelGenerateGUI(modelGenerateGUIMain):
    def __init__(self, parent=None):
        ...
        self.mainFormLay.addRow(QtWidgets.QLabel("l1"), self.len_1)
        self.mainFormLay.addRow(QtWidgets.QLabel("l2"), self.len_3)
...
def modelGenerate(doc, widget):
    ...
    doc.Spreadsheet.set('B4', str(widget.len_3.value()))
    doc.Spreadsheet.set('B5', str(widget.len_2.value()))
    doc.recompute()
