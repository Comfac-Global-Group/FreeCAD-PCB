...
class modelGenerateGUI(modelGenerateGUIMain):
    def __init__(self, parent=None):
        ...
        #
        self.pinsHeight3 = QtWidgets.QDoubleSpinBox()
        ...
        #
        self.numberOfSupports = QtWidgets.QSpinBox()
        ...
        #
        self.supportsSpacing = QtWidgets.QDoubleSpinBox()
        ...
        self.mainFormLay.addRow(QtWidgets.QLabel("Number of rows"), self.numberOfRows)
        self.mainFormLay.addRow(QtWidgets.QLabel("Number of cols"), self.numberOfCols)
        self.mainFormLay.addRow(QtWidgets.QLabel("Raster (r)"), autVariable(2.54))
        self.mainFormLay.addRow(QtWidgets.QLabel("Pins height (h1)"), self.pinsHeight1)
        self.mainFormLay.addRow(QtWidgets.QLabel("Pins height (h2)"), autVariable(2.54))
        self.mainFormLay.addRow(QtWidgets.QLabel("Pins height (h3)"), self.pinsHeight3)
        self.mainFormLay.addRow(QtWidgets.QLabel("Number of supports"), self.numberOfSupports)
        self.mainFormLay.addRow(QtWidgets.QLabel("Distance between supports (l)"), self.supportsSpacing)
