...
class moveWizardWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        QtWidgets.QWidget.__init__(self, parent)
        #
        self.listaBibliotek = QtWidgets.QComboBox()
        self.listaBibliotekInfo = QtWidgets.QLabel(' ')
        #
        self.positionX = QtWidgets.QDoubleSpinBox()
        self.positionX.setSingleStep(0.1)
        self.positionX.setRange(-1000, 1000)
        self.positionX.setSuffix(' mm')
        self.positionY = QtWidgets.QDoubleSpinBox()
        self.positionY.setSingleStep(0.1)
        self.positionY.setRange(-1000, 1000)
        self.positionY.setSuffix(' mm')
        self.positionZ = QtWidgets.QDoubleSpinBox()
        self.positionZ.setSingleStep(0.1)
        self.positionZ.setRange(-1000, 1000)
        self.positionZ.setSuffix(' mm')
        self.rotationRX = QtWidgets.QDoubleSpinBox()
        self.rotationRX.setSingleStep(0.1)
        self.rotationRX.setRange(-360, 360)
        self.rotationRX.setSuffix(' deg')
        self.rotationRY = QtWidgets.QDoubleSpinBox()
        self.rotationRY.setSingleStep(0.1)
        self.rotationRY.setRange(-360, 360)
        self.rotationRY.setSuffix(' deg')
        self.rotationRZ = QtWidgets.QDoubleSpinBox()
        self.rotationRZ.setSingleStep(0.1)
        self.rotationRZ.setRange(-360, 360)
        self.rotationRZ.setSuffix(' deg')
        #
        translationFrame = QtWidgets.QGroupBox(u'Translation:')
        translationFrameLay = QtWidgets.QFormLayout(translationFrame)
        translationFrameLay.addRow(QtWidgets.QLabel('X:'), self.positionX)
        translationFrameLay.addRow(QtWidgets.QLabel('Y:'), self.positionY)
        translationFrameLay.addRow(QtWidgets.QLabel('Z:'), self.positionZ)
        translationFrameLay.setContentsMargins(5, 5, 5, 5)
        #
        rotationFrame = QtWidgets.QGroupBox(u'Rotation:')
        rotationFrameLay = QtWidgets.QFormLayout(rotationFrame)
        rotationFrameLay.addRow(QtWidgets.QLabel('RX:'), self.rotationRX)
        rotationFrameLay.addRow(QtWidgets.QLabel('RY:'), self.rotationRY)
        rotationFrameLay.addRow(QtWidgets.QLabel('RZ:'), self.rotationRZ)
        rotationFrameLay.setContentsMargins(5, 5, 5, 5)
        #
        libraryFrame = QtWidgets.QGroupBox(u'Library:')
        libraryFrameLay = QtWidgets.QVBoxLayout(libraryFrame)
        libraryFrameLay.addWidget(self.listaBibliotek)
        libraryFrameLay.addWidget(self.listaBibliotekInfo)
        #
        self.resetButton = QtWidgets.QPushButton(u'Reset')
        ...
        lay.addItem(QtWidgets.QSpacerItem(1, 10), 2, 0, 1, 2)
